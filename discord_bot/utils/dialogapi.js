  ...
  if (response.data.length != 0) {
    ...
    if (isEnding === true) {
      ...
      try {
        ...
        avatarURL = interaction.user.displayAvatarURL({ format: 'png', dynamic: true, size: 1024 })
      } catch {
        userName = interaction.author.username
        avatarURL = interaction.author.displayAvatarURL({ format: 'png', dynamic: true, size: 1024 })
      }
